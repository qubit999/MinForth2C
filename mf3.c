...
void mf3293E7B6(void); // __XCEXCSRC
...
void mf3DCBFC8F(void); // __LASTPRIM
void mf019A9A4A(void); // __OVCHK
void mfFEC32A89(void); // SAVED-OVERLAY
void mf18267E7D(void); // LOADED-OVERLAY
void mf000DC805(void); // SAVE-OVERLAY
void mfBEBD34F4(void); // LOAD-OVERLAY
void mfEB068801(void); // __CURSOR
void mfDF9A734D(void); // __CURLN
void mf669BFA2F(void); // __CURCOL
void mf3A1B4CE7(void); // __CURPOS
void mfE489B470(void); // __CURADR
void mfCC6C6571(void); // __CURLNPOS
void mf40065609(void); // __CURLNOFS
void mf7ED04C36(void); // __CURLNADR
void mfB07A7006(void); // __CURBLK
void mfC329CD1B(void); // __SHOW-LINE
void mfBF161DB5(void); // __SHOW-SCREEN
void mfC461B54D(void); // __BESHCRS
void mf7A2F3C08(void); // __HIDE-CURSOR
void mf458CEF4B(void); // __SHOW-CURSOR
void mfC337494A(void); // __BELNBLANK
void mf75295E74(void); // __BESCRBLANK
void mf99466660(void); // __BERIGHT
void mf41579E4F(void); // __BELEFT
void mfE35BD81A(void); // __BEDOWN
void mfF5D8B5FF(void); // __BEUP
void mf232A53E8(void); // __BEFIRST
void mfF38D5CFD(void); // __BEHOME
void mf9CF23BCF(void); // __BEEND
void mfD0D8F836(void); // __BELAST
void mfDDCB46CC(void); // __BERETURN
void mf94C659FD(void); // __BEDELETE
void mf738DF67B(void); // __BEINSERT
void mfAE9FEDA9(void); // __BEBS
void mf0FCEFB96(void); // __BECHAR
void mf664175C0(void); // __BELERASE
void mfED37BC9B(void); // __BELREREAD
void mfFB5B5E61(void); // __BELERASELEFT
void mf1E5E14A2(void); // __BELERASERIGHT
void mfA6AFDE03(void); // __BELINSERT
void mf25EDF0F5(void); // __BELDELETE
void mfCAAB52B0(void); // __BEGO
void mf3866C07E(void); // __BELIST
void mf595AE28E(void); // __STLINE
void mf6A0C1543(void); // __BEBGOTO
void mf5BF5570E(void); // __BEBFIRST
void mfD6C5134C(void); // __BEBPRIOR
void mf7C38A391(void); // __BEBNEXT
void mfB06D9630(void); // __BEBLAST
void mfD588D786(void); // __BEINPUT
void mf1F4118F2(void); // __BEBERASE
void mf8CD682C5(void); // __BEBINSERT
void mf9F70F15B(void); // __BEBDELETE
void mfFD719D69(void); // __BEBREREAD
void mf342A29BD(void); // __BEBSAVE
void mf9DAAFB6B(void); // _STAMP$
void mfB09AA5C7(void); // __BEBSTAMP
void mfFAD0B545(void); // __BEHELP
void mf9156B79A(void); // __BEEXIT
void mf4B383999(void); // BLOCK-EDIT
...
mfHdr mfdict[785]={{NULL,0,NULL,NULL},
...
{mfdict+334,0,"\010ALLOCATE",mfE69B7462},
{mfdict+335,0,"\004FREE",mf97A522DB},
{mfdict+336,0,"\006RESIZE",mfAF26F721},
{mfdict+337,0,"\017SEARCH-WORDLIST",mfC090D7CC},
{mfdict+338,0,"\016FORTH-WORDLIST",mf346A6677},
{mfdict+339,0,"\005ORDER",mfDAF5E977},
{mfdict+758,0,"\002.S",mf66D44706},
{mfdict+759,0,"\003.RS",mf3D2E95FE},
{mfdict+760,0,"\003.FS",mf35602632},
{mfdict+761,0,"\004DUMP",mfC6897287},
{mfdict+762,0,"\006XT-SEE",mf6B7D8387},
{mfdict+763,0,"\003SEE",mf38016820},
{mfdict,0,"\007_[DEB:]",mfFBBF5FA7},
{mfdict,0,"\006_UNBUG",mf0EE95A7D},
{mfdict+764,0,"\011UNBUG-ALL",mf4C2C9E72},
{mfdict+767,0,"\005UNBUG",mf7E05BCA0},
{mfdict+768,0,"\005DEBUG",mf685108F8},
{mfdict+769,0,"\015SAVED-OVERLAY",mfFEC32A89},
{mfdict+770,0,"\016LOADED-OVERLAY",mf18267E7D},
{mfdict+771,1,"\014SAVE-OVERLAY",mf000DC805},
{mfdict+772,1,"\014LOAD-OVERLAY",mfBEBD34F4},
{mfdict,0,"\007_STAMP$",mf9DAAFB6B},
{mfdict+773,0,"\012BLOCK-EDIT",mf4B383999},
{mfdict+775,0,"\004MAIN",mf96272888},
{mfdict,0,"\005_STDS",mfCDA5B50C},
{mfdict,0,"\005_STDE",mfDBA5CB16},
{mfdict,0,"\010_VERBOSE",mf5BF2539C},
{mfdict,0,"\004_ATB",mf1E9174EB},
{mfdict+776,0,"\007TESTING",mfF959CA7B},
{mfdict+781,0,"\002T{",mf4DF5A928},
{mfdict+782,0,"\002->",mf11CD0572},
{mfdict+783,0,"\002}T",mf7756E4B4}};
...
mfXT MF9FC8664E=mf3293E7B6; // IS __XCEXCSRC
...
mfXT MF28B3832A=mf82118574; // IS __FCBOOT
...
void mf249E5635(void) { // : __DBOOT
  mf5547E6F8(); // __SBOOT
  mfpush(&mfdict[409].cfa); // ['] _DOUBLE?
  mfpush(&mfdict[32].cfa); // ['] NOOP
  mfpush(&mfdict[405].cfa); // ['] 2LITERAL
...
void mf5D7A6040(void) { // : FLITERAL
  mfat(mfdp)=(mfCell)&mfdict[518].cfa;
  mfdp+=MFSIZE; // [,] _[FLIT]
  mf20D2D00F(); // F,
} // IMMEDIATE COMPILE-ONLY
...
void mfA157AEE6(void) { // : FVALUE
  mfpush(&mfdict[488].cfa); // ['] F@
  mfpush(&mfdict[489].cfa); // ['] F!
  mfpush(&mfdict[432].cfa); // ['] F+
  mf24D3F916(); // _(VALUE)
  mf20D2D00F(); // F,
}
...
void mf6502BC33(void) { // : __FBOOT
  mf249E5635(); // __DBOOT
  mfpush(&mfdict[517].cfa); // ['] >FLOAT
  mfpush(&mfdict[32].cfa); // ['] NOOP
  mfpush(&mfdict[520].cfa); // ['] FLITERAL
  mfspush("REC-FLOAT"); // S"
  mf9DA7D846(); // NAMED
  mf5E8B98AB(); // RECOGNIZER
}
...
void mfE291D512(void) { // : ZVALUE
  mfpush(&mfdict[537].cfa); // ['] Z@
  mfpush(&mfdict[536].cfa); // ['] Z!
  mfpush(&mfdict[552].cfa); // ['] Z+
  mf24D3F916(); // _(VALUE)
  mf20D2D00F(); // F,
  mf20D2D00F(); // F,
}
...
void mf1E1FE1D0(void) { // : __CXBOOT
  mf6502BC33(); // __FBOOT
  mfpush(&mfdict[576].cfa); // ['] >COMPLEX
  mfpush(&mfdict[32].cfa); // ['] NOOP
  mfpush(&mfdict[577].cfa); // ['] ZLITERAL
...
void mfBF5EECFC(void) { // : _[LOC@]
  mferr(mfout(2));  
  mfat(mfdp)=(mfCell)&mfdict[583].cfa;
  mfdp+=MFSIZE; // [,] _[L]
  mfpush(mfw);
  mf57E80646(); // DUP
  mf3C6699A2(); // _>VD
...
mfTHEN
  ...
  mfpush(&MF7A4A03B8); // __TLOCE
  mf240C8DEC(); // !
  mfat(mfdp)=(mfCell)&mfdict[581].cfa;
  mfdp+=MFSIZE; // [,] _[L:]
  mfpush(&MF5CD08362); // __LDEPTH
  mfC50BF85F(); // @
  mf290C95CB(); // ,
...
mfNOTIF
  ...
  mf280C9438(); // -
  mf3FA1943F(); // ALLOT
  mfat(mfdp)=(mfCell)&mfdict[582].cfa;
  mfdp+=MFSIZE; // [,] _[;L]
mfTHEN
  mfpush(&MF7571BB77); // _TEMPWL
  mf2E1505EA(); // OFF
...
mfIF
  mf50BE3701(); // SLITERAL
  mfat(mfdp)=(mfCell)&mfdict[723].cfa;
  mfdp+=MFSIZE; // [,] PRINTF
mfELSE
  mfB81DD0EA(); // PRINTF
mfTHEN
...
void mf3DCBFC8F(void) { // : __LASTPRIM
  mfpush(mfdict+MFPRIMS);
}

mfCell MF019A9A4A=0; // 0

void mf019A9A4A(void) { // VARIABLE __OVCHK
  mfpush(&MF019A9A4A);
}
...
void mfFEC32A89(void) { // : SAVED-OVERLAY
  ...
  mfD2C02CE6(); // CREATE-FILE
  (MFE5B4B40F)(); // THROW
  mf3DCBFC8F(); // __LASTPRIM
  mfpush(&MF019A9A4A); // __OVCHK
  mf240C8DEC(); // !
  mfpush(&MF019A9A4A); // __OVCHK
  mf662FFFF5(); // CELL
  mf6AB5854A(); // PLUCK
...
mfIF
  mf50BE3701(); // SLITERAL
  mfat(mfdp)=(mfCell)&mfdict[770].cfa;
  mfdp+=MFSIZE; // [,] SAVED-OVERLAY
mfELSE
  mfFEC32A89(); // SAVED-OVERLAY
mfTHEN
} // IMMEDIATE 
...
mfIF
  mf50BE3701(); // SLITERAL
  mfat(mfdp)=(mfCell)&mfdict[771].cfa;
  mfdp+=MFSIZE; // [,] LOADED-OVERLAY
mfELSE
  mf18267E7D(); // LOADED-OVERLAY
mfTHEN
} // IMMEDIATE 

mfCell MFEB068801=0; // 0

void mfEB068801(void) { // VARIABLE __CURSOR
  mfpush(&MFEB068801);
}

void mfDF9A734D(void) { // : __CURLN
  mfpush(&MFEB068801); // __CURSOR
  mfC50BF85F(); // @
  mfpush(6); // $6
  mf24728B77(); // RSHIFT
}
...
void mfC329CD1B(void) { // : __SHOW-LINE
  mfCC6C6571(); // __CURLNPOS
  mfBEE2C2F4(); // AT-XY
  mf7ED04C36(); // __CURLNADR
  mfpush(64); // $40
  mf142FE78D(); // TYPE
}
...
mfTHEN
  mfD9BC5E8A(); // EMIT
mfTHEN
  mf5C0DBF87(); // RESTORE-XY
}

void mf7A2F3C08(void) { // : __HIDE-CURSOR
  mfpush(MFEE597878); // FALSE
  mfC461B54D(); // __BESHCRS
}
...
mfCell MFCAAB52B0=0; // 0

void mfCAAB52B0(void) { // VARIABLE __BEGO
  mfpush(&MFCAAB52B0);
}
...
void mf6A0C1543(void) { // : __BEBGOTO
  mf595AE28E(); // __STLINE
  mf7F99FF1B(); // VTERASE
  mfprint("Goto BLOCK # "); // S"
  mfpush(&MFCAAB52B0); // __BEGO
  mfpush(4); // $4
  (MF209E17E9)(); // ACCEPT
  mf595AE28E(); // __STLINE
  mf7F99FF1B(); // VTERASE
...
mfTHEN
  mfEF6476DC(); // 2DROP
  mf595AE28E(); // __STLINE
  mfprint("?? invalid block number (press key)"); // S"
  mf38E5C67F(); // EKEY
  mf52C16B0C(); // DROP
  mf595AE28E(); // __STLINE
  mf7F99FF1B(); // VTERASE
...
void mf1F4118F2(void) { // : __BEBERASE
  mfspush("Erase block? (y/n) "); // S"
  mfD588D786(); // __BEINPUT
  mfpush(121); // $79
  mf380CAD68(); // =
mfNOTIF
mfEXIT
...
void mf8CD682C5(void) { // : __BEBINSERT
  mfspush("Insert block (last block will be deleted)? (y/n) "); // S"
  mfD588D786(); // __BEINPUT
  mfpush(121); // $79
  mf380CAD68(); // =
mfNOTIF
...
void mf9F70F15B(void) { // : __BEBDELETE
  mfspush("Delete block (current block will be overwritten)? (y/n) "); // S"
  mfD588D786(); // __BEINPUT
  mfpush(121); // $79
  mf380CAD68(); // =
mfNOTIF
...
mfN
  ...
  mf8C12EE82(); // SPACES
mfNEXT
  mfspush("Misc.:         shF1:help ^t:stamp ^s:save ^x:exit"); // S"
  mfspush("Edit block:    shF2:erase shF3:ins shF4:del shF5:goto"); // S"
  mfspush("Move to block: ^pgup:first pgup:prior pgdn:next ^pgdn:last"); // S"
  mfspush("Edit line:     esc ^ret/^<-/^->:tot/l/r-erase ^F3:ins ^F4:del"); // S"
  mfspush("Edit text:     chars bs ins del"); // S"
  mfspush("Move cursor:   arrows tab home end ^home ^end ret"); // S"
  mfspush("-- HELP (F1) ---- (^:ctrl+key sh:shift+key) --------------------"); // S"
  mf4B114CCB(); // VTBRIGHT
  mfAFA0318C(); // VTCYAN
  mfpush(7); // $7
mfFOR
...
mfTHEN
  mf6A78A9B6(); // PAGE
  mfspush("~c~v MinForth BLOCK-Editor"); // S"
  mfB81DD0EA(); // PRINTF
  mfpush(9); // $9
  mf8C12EE82(); // SPACES
  mfspush("shF1:Help  ^r:reRead  ^s:Save  ^x:eXit ~n"); // S"
  mfB81DD0EA(); // PRINTF
  mf0A4EBBC1(); // LIST
  mf64D9F6E0(); // CR
  mf31B023B4(); // SAVE-XY
...
mfENDOF
  mfpush(MF8D5A8F90); // K-LEFT
  mfpush(MF08D7F4BF); // K-CTRL-MASK
  mf7CE4AA04(); // OR
mfOF
  mfFB5B5E61(); // __BELERASELEFT
mfENDOF
  mfpush(MF3280C6E5); // K-RIGHT
mfOF
  mf99466660(); // __BERIGHT
...
mfENDOF
  mfpush(MF3653A2EA); // K-DELETE
mfOF
  mf94C659FD(); // __BEDELETE
mfENDOF
  mfpush(MFA0546E08); // K-INSERT
mfOF
  mf738DF67B(); // __BEINSERT
mfENDOF
  mfpush(MF96DF0DF7); // K-PRIOR
mfOF
  mfD6C5134C(); // __BEBPRIOR
mfENDOF
  mfpush(MF96DF0DF7); // K-PRIOR
  mfpush(MF08D7F4BF); // K-CTRL-MASK
  mf7CE4AA04(); // OR
mfOF
  mf5BF5570E(); // __BEBFIRST
mfENDOF
  mfpush(MFD2B09D08); // K-NEXT
mfOF
  mf7C38A391(); // __BEBNEXT
mfENDOF
  mfpush(MFD2B09D08); // K-NEXT
  mfpush(MF08D7F4BF); // K-CTRL-MASK
  mf7CE4AA04(); // OR
mfOF
  mfB06D9630(); // __BEBLAST
mfENDOF
  mfpush(MF7693439E); // K-F3
  mfpush(MF08D7F4BF); // K-CTRL-MASK
  mf7CE4AA04(); // OR
mfOF
  mfA6AFDE03(); // __BELINSERT
mfENDOF
  mfpush(MF79934857); // K-F4
  mfpush(MF08D7F4BF); // K-CTRL-MASK
  mf7CE4AA04(); // OR
mfOF
  mf25EDF0F5(); // __BELDELETE
mfENDOF
  mfpush(MF74934078); // K-F1
  mfpush(MF4D1CE30E); // K-SHIFT-MASK
  mf7CE4AA04(); // OR
mfOF
  mfFAD0B545(); // __BEHELP
mfENDOF
  mfpush(MF77934531); // K-F2
  mfpush(MF4D1CE30E); // K-SHIFT-MASK
  mf7CE4AA04(); // OR
mfOF
  mf1F4118F2(); // __BEBERASE
mfENDOF
  mfpush(MF7693439E); // K-F3
  mfpush(MF4D1CE30E); // K-SHIFT-MASK
  mf7CE4AA04(); // OR
mfOF
  mf8CD682C5(); // __BEBINSERT
mfENDOF
  mfpush(MF79934857); // K-F4
  mfpush(MF4D1CE30E); // K-SHIFT-MASK
  mf7CE4AA04(); // OR
mfOF
  mf9F70F15B(); // __BEBDELETE
mfENDOF
  mfpush(MF789346C4); // K-F5
  mfpush(MF4D1CE30E); // K-SHIFT-MASK
  mf7CE4AA04(); // OR
mfOF
  mf6A0C1543(); // __BEBGOTO
mfENDOF
mfENDCASE
mfELSE
  mf57E80646(); // DUP
...
mfCASE
  mfpush(27); // $1B
mfOF
  mfED37BC9B(); // __BELREREAD
mfENDOF
  mfpush(20); // $14
mfOF
  mfB09AA5C7(); // __BEBSTAMP
mfENDOF
  mfpush(19); // $13
mfOF
  mf342A29BD(); // __BEBSAVE
mfENDOF
  mfpush(18); // $12
mfOF
  mfFD719D69(); // __BEBREREAD
mfENDOF
  mfpush(13); // $D
mfOF
  mfDDCB46CC(); // __BERETURN
mfENDOF
  mfpush(8); // $8
mfOF
  mfAE9FEDA9(); // __BEBS
